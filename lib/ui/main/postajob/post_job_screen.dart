          ...
          children: [
            Expanded(
              child: Stepper(
                ...
                steps: <Step>[
                  Step(
                    title: Text("Company information ",style: TextStyle(fontSize: textSize20,fontWeight: FontWeight.w600),),
                    content: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        SizedBox(height: 10),
                        Align(alignment:Alignment.center,child: Text("Company Logo",style: TextStyle(fontSize: textSize15,fontWeight: FontWeight.w600),)),
                        SizedBox(height: 5),
                        GestureDetector(
                          onTap: () {
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: Colors.white,
                                    border: Border.all(color: Color(0xFF286472), width: 1),
                        ...
                        RichText(
                          text: TextSpan(children: [
                            TextSpan(
                                text: "Company Name",
                                style: TextStyle(
                                    fontSize: textSize13,color: Colors.black
                                )),
                            TextSpan(
                                text: " *",
                                style: TextStyle(
                  ...
                  Step(
                    title: Text("Job Descripition",style: TextStyle(fontSize: textSize20,fontWeight: FontWeight.w600),),
                    content: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        SizedBox(height: 5.h),
                  ...
                  Step(
                    title: Text("Job details",style: TextStyle(fontSize: textSize20,fontWeight: FontWeight.w600),),
                    content: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        SizedBox(height: 10),
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("1 - 2",style: TextStyle(
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("2 - 5",style: TextStyle(
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text("5 - 10",style: TextStyle(
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                width: 60,
                                decoration: BoxDecoration(
                                    color: selected == 'fourth' ? Colors.blue : Colors.transparent,
                                    border: Border.all(
                                      color: Colors.blue,
                                      width: 1,
                                    ),
                                ...
                                child: Center(child: Text("10+",style: TextStyle(
                                    color:selected == 'fourth' ? Colors.white : Colors.black),)),),
                            ),
                          ],
                        ),
                        // Container(
                        ...
                        Row(
                          ...
                          children: [
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Salary offered",    style: TextStyle(
                                    fontSize: textSize14,color: Colors.black
                                )),
                                Text("Min Salary",    style: TextStyle(
                                    fontSize: textSize10,color: Colors.grey[600]
                                )),
                              ],
                            ),
                            Text("Salary Type",    style: TextStyle(
                                fontSize: textSize14,color: Colors.black
                            )),
                          ],
                        ),
                        ...
                        SizedBox( height: 15),
                        Text("Max Salary",    style: TextStyle(
                            fontSize: textSize10,color: Colors.grey[600]
                        )),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
