...
const List<Choice> choices = const <Choice>[
  const Choice(title: 'Information Technology', image: "assets/images/informationlogo.png"),
  const Choice(title: 'Management', image: "assets/images/management1.png"),
  const Choice(title: 'Archictecture & Engineer', image: "assets/images/engineering.png"),
  const Choice(title: 'Agriculture', image: "assets/images/tractor1.png"),
  const Choice(title: 'Banking and Finance', image: "assets/images/bankbuilding.png"),
  const Choice(title: 'law', image: "assets/images/law1.png"),
  const Choice(title: 'Leisure Sports and Tourism', image: "assets/images/touristfemale.png"),
  const Choice(title: 'Advertising and PR', image: "assets/images/webadvertising.png"),
  const Choice(title: 'Accounting', image: "assets/images/positivedynamic.png"),
  const Choice(title: 'Education and Training', image: "assets/images/university.png"),
  const Choice(title: 'Graphic Design', image: "assets/images/picture.png"),
  const Choice(title: 'Health and Hospital', image: "assets/images/hospital.png"),
  const Choice(title: 'Restaurant and Food', image: "assets/images/restaurant.png"),
  const Choice(title: 'Security and Safety', image: "assets/images/privacy.png"),
