...
class ResubmitJobsScreen extends StatefulWidget {
  @override
  _ResubmitJobsScreenState createState() => _ResubmitJobsScreenState();
}

class _ResubmitJobsScreenState extends State<ResubmitJobsScreen> {
